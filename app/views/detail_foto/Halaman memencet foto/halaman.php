...
<body class="bg-[radial-gradient(circle_at_top_left,#2E3A5E,#1E263D)] min-h-screen flex justify-center items-center font-[Poppins] relative overflow-x-hidden">

  <!-- Background Pattern -->
  <div class="fixed inset-0 opacity-[0.04] pointer-events-none bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
  ...
  <div class="w-[90%] max-w-[800px] relative z-10">
    ...
    <!-- Card -->
    <div class="flex flex-col md:flex-row gap-8 bg-white p-8 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.2)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)]">
      ...
      <div class="flex-1 flex flex-col justify-center">
        ...
        <h2 class="text-[28px] font-bold text-[#111] leading-tight">
          Juara Pertama Fashion Show Competition
        </h2>
        ...
        <div class="flex mb-3 text-[15px]">
          <span class="font-semibold w-20 text-gray-800">Mapel</span>
          <span class="text-gray-600">: -</span>
        </div>
        ...
        <div class="mt-5">
          ...
          <p class="text-gray-600 leading-relaxed text-sm">
            SMK Kristen Immanuel kembali menorehkan prestasi membanggakan melalui salah satu siswinya yang berhasil meraih Juara Pertama dalam ajang Fashion Show Competition yang diselenggarakan dalam rangka Seminar & Dies Natalis XV HMBM FKIP Universitas Tanjungpura. Prestasi ini menunjukkan bahwa siswa SMK Kristen Immanuel mampu berprestasi tidak hanya dalam bidang akademik, tetapi juga dalam bidang seni dan kreativitas.
          </p>
  ...
  >
    ...
    <span 
      id="closeModal"
      class="absolute top-5 right-8 text-white text-5xl cursor-pointer hover:text-yellow-400"
    >
      &times;
    </span>
    ...
    <img 
      id="modalImg"
      alt="Modal Artwork"
      class="w-full max-w-[1000px] max-h-[90vh]"
    >
